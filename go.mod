...
replace (
	...
	k8s.io/cloud-provider => k8s.io/cloud-provider v0.23.16
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.23.16
	k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers v0.23.16
	k8s.io/mount-utils => k8s.io/mount-utils v0.23.16
	k8s.io/sample-apiserver => k8s.io/sample-apiserver v0.23.16
